...
final class Version20220128175259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property ADD features_id INT NOT NULL, ADD type_id INT NOT NULL, ADD status_id INT NOT NULL, ADD address_id INT DEFAULT NULL, ADD coordinates_id INT DEFAULT NULL, ADD files_id INT NOT NULL, ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property DROP features_id, DROP type_id, DROP status_id, DROP address_id, DROP coordinates_id, DROP files_id, DROP user_id');
